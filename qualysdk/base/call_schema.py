...
CALL_SCHEMA = frozendict(
    {
        ...
        "cloudview": {  # TOTALCLOUD
            "url_type": "base",
            "get_ec2_instances": {
                "endpoint": "/cloudview-api/rest/v1/resource/EC2_INSTANCE/AWS",
                "method": ["GET"],
            ...
            "get_vpc_security_groups": {
                "endpoint": "/cloudview-api/rest/v1/resource/VPC_SECURITY_GROUP/AWS",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
            ...
            "get_load_balancers": {
                "endpoint": "/cloudview-api/rest/v1/resource/LOAD_BALANCER/AWS",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
            ...
            "get_iam_roles": {
                "endpoint": "/cloudview-api/rest/v1/resource/IAM_ROLE/AWS",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
            ...
            "get_rds_databases": {
                "endpoint": "/cloudview-api/rest/v1/resource/RDS/AWS",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
            ...
            "get_control_evaluations": {
                "endpoint": "/cloudview-api/rest/v1/aws/evaluations",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
            ...
            "get_resources_for_control": {
                "endpoint": "/cloudview-api/rest/v1/aws/evaluations/{accountId}/resources/{controlId}",
                "method": ["GET"],
                "valid_params": ["pageNo", "pageSize", "filter"],
                "valid_POST_data": [],
                "use_requests_json_data": False,
