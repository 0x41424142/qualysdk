...
class StaticSearchList:
    ...
    TITLE: str = field(metadata={"description": "The title of the Static Search List."}, default=None)
    GLOBAL: bool = field(
        metadata={"description": "Whether the Static Search List is global."}, default=None
    )
    OWNER: str = field(metadata={"description": "The owner of the Static Search List."}, default=None)
    ...
    MODIFIED: Union[str, datetime] = field(
        metadata={"description": "The date the Static Search List was last modified."}, default=None
    )
    MODIFIED_BY: str = field(
        metadata={"description": "The user who last modified the Static Search List."}, default=None
    )
    ...
    REMEDIATION_POLICIES: BaseList[dict] = field(
        metadata={"description": "The remediation policies associated with the Static Search List."},
        default=None
    )
